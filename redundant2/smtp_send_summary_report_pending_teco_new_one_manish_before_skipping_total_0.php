...
foreach ($inchargeCombinations as $incharge) {
    ...
    //     $mail->addCC(trim($incharge['STATE ENGG HEAD']));
    // }
    // if (!empty($incharge['AREA INCHARGE'])) {
    //     $mail->addCC(trim($incharge['AREA INCHARGE']));
    // }
    // if (!empty($incharge['SITE INCHARGE'])) {
    //     $mail->addCC(trim($incharge['SITE INCHARGE']));
    // }
    // if (!empty($incharge['STATE PMO'])) {
    //     $mail->addCC(trim($incharge['STATE PMO']));
    // }
}
